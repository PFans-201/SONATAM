...
Usage
-----
>>> from sonata.generation.musicxml_writer import write_musicxml
>>> write_musicxml(["C:maj", "A:min", "F:maj", "G:7"], "data/processed/progression.musicxml")
"""
...
from sonata.generation.midi_writer import progression_to_score
