...
schema.py
=========
Knowledge-graph schema constants for the Harmonic-KG project.
...
class HarmonicKGSchema:
    ...
    by the Harmonic-KG project.

    Usage
    -----
    >>> from harmonic_kg_project.knowledge_graph.schema import HarmonicKGSchema as S
    >>> g = rdflib.Graph()
    >>> g.bind("hkg", S.NS)
    ...
    chordPosition     = NS["chordPosition"]       # beat offset
