...
queries.py
==========
SPARQL query helpers and graph traversal utilities for the Harmonic-KG.
...
Usage
-----
>>> from harmonic_kg_project.knowledge_graph import KGQueries
>>> q = KGQueries(graph)
...
from .schema import HarmonicKGSchema as S
...
class KGQueries:
    """
    SPARQL query helpers for the Harmonic-KG rdflib graph.
